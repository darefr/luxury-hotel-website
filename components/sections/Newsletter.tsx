  ...
  return (
    <section className="py-24 bg-midnight-2 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          <p className="label-luxury mb-4">Stay Informed</p>
          <h2 className="font-serif text-5xl md:text-6xl font-light text-ivory mb-5">
            Private Invitations &amp; Seasonal Offers
          </h2>
          <p className="font-sans text-sm text-ivory/50 leading-relaxed mb-10">
            Join our exclusive list for early access to seasonal packages, curated experiences,
            and invitations to private member events. We value your privacy — no spam, ever.
          </p>
