...
const STATS = [
  { value: 6,   suffix: ' min', label: 'To Phewa Lake',   desc: 'A short walk away' },
  { value: 2,   suffix: '',     label: 'Room Types',       desc: 'Double & Family rooms' },
  { value: 2,   suffix: '-Star', label: 'Hotel Category',  desc: 'Clean & comfortable' },
  { value: 18,  suffix: ' min', label: 'To Lakeside',      desc: 'Cafes, shops & the lake' },
  { value: 1,   suffix: ' PM',  label: 'Check-in From',    desc: 'Check-out by 12 noon' },
  { value: 100, suffix: '%',    label: 'Free Parking',     desc: 'Complimentary on-site' },
]
