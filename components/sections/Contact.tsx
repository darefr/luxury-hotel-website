        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <p className="font-sans text-sm text-ivory/50 leading-relaxed mb-10">
              Whether you are booking your stay or have a question about getting to Pokhara,
              our front desk is happy to help. Send us a message and we&apos;ll get back to you.
            </p>
            <div className="space-y-4">
              {[
                ["Reservations", "+977 985-1019065"],
                ["WhatsApp", "+977 985-1019065"],
                ["Address", "Simalchaur, Pokhara, Nepal"],
              ].map(([label, val]) => (
            ...
            {submitted ? (
              ...
              >
                ...
                <p className="font-sans text-sm text-ivory/50 max-w-xs">
                  Thank you, {form.name}. Our front desk will get back to you as soon as possible.
                </p>
              </motion.div>
            ) : (
