...
const navLinks = [
  ...
  { label: "Comfort",         href: "#spa" },
  { label: "Explore Pokhara", href: "#experiences" },
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-12 mb-14">
          ...
          >
            <div className="font-serif text-3xl tracking-[0.2em] text-ivory mb-2">
              HOTEL <span className="text-copper">SONAM</span>
            </div>
            <p className="label-luxury text-[0.55rem] text-ivory/30 mb-5">Simalchaur — Pokhara, Nepal</p>
            <p className="font-sans text-sm text-ivory/45 leading-relaxed max-w-xs">
              A warm, family-run hotel a short walk from Phewa Lake — comfortable rooms with balconies, an on-site restaurant, and genuine Nepali hospitality.
            </p>
          ...
          >
            <h3 className="label-luxury text-[0.55rem] text-copper mb-6">Good to Know</h3>
            <div className="space-y-4">
              {[
                ["Google Reviews",         "Rated 4.9 / 5 by guests"],
                ["Category",               "2-star hotel"],
                ["Location",               "6 min walk to Phewa Lake"],
                ["On-site Restaurant",     "Nepali & continental dishes"],
              ].map(([org, award]) => (
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="font-sans text-ivory/25 text-xs">
            &copy; {new Date().getFullYear()} Hotel Sonam, Pokhara. All rights reserved.
          </p>
